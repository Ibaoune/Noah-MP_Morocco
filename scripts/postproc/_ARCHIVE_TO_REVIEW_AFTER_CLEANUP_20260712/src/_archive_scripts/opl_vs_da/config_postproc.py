...
"""
===============================================================================
Script: config_postproc.py
Author: M. El Aabaribaoune (@um6p)

Objective: Project-wide constants and legacy statistical configurations.

Description:
    This file contains hardcoded paths, plot dictionaries (e.g., standard 
    colors for experiments), and legacy statistical functions (NSE, KGE, 
    RMSE). Note: For the newer YAML-driven plotting framework, paths and 
    variables are primarily managed in 'config_opl_da.yaml'.
===============================================================================
"""
import os
import numpy as np
...
DIR_OUTPUT_OL = os.path.join(PROJECT_ROOT, "experiments/NorthMor/matrix_2016/OPL_noirr_2016/output")
DIR_OUTPUT_DA = os.path.join(PROJECT_ROOT, "experiments/NorthMor/matrix_2016/DA_nocdf_noirr_2016/output")
...
DIR_FIGURES_OPL_VS_DA = os.path.join(DIR_FIGURES, "opl_vs_da", "matrix_2016")
