...
class LISLoader:
    ...
    def load_variable(exp_dir, variable_name, start_date=None, end_date=None):
        ...
        try:
            ds = xr.open_mfdataset(files, combine='by_coords', engine='netcdf4', preprocess=preprocess, chunks={'time': 1})
        except Exception as e:
            ds = xr.open_mfdataset(files, combine='nested', concat_dim='time', engine='netcdf4', preprocess=preprocess, chunks={'time': 1})
