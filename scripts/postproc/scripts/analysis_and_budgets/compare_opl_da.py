...
def plot_spatial_diff(opl_data, da_data, var_name, title, cmap='RdBu'):
    ...
    plt.title(f"{title} (DA - OPL Time Average)", fontsize=14, fontweight="bold", pad=15)
...
def plot_basin_time_series():
    ...
    if opl_qs is not None and da_qs is not None:
        ...
        axes[0].set_title('Basin-Averaged Surface Runoff', fontsize=12, fontweight='bold')
    ...
    if opl_sm is not None and da_sm is not None:
        ...
        axes[1].set_title('Basin-Averaged Top Layer Soil Moisture', fontsize=12, fontweight='bold')
    ...
    if opl_et is not None and da_et is not None:
        ...
        axes[2].set_title('Basin-Averaged Evapotranspiration', fontsize=12, fontweight='bold')
