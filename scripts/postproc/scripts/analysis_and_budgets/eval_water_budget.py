...
def plot_budget_residual():
    ...
    plt.title('Water Budget Closure Residual', fontsize=14, fontweight='bold')
...
def plot_runoff_partitioning():
    ...
    plt.xlabel('Days since start', fontweight='bold')
    plt.title('Runoff Partitioning Dynamics', fontsize=14, fontweight='bold')
    plt.legend(frameon=True, shadow=True)
...
def plot_sm_profile_evolution():
    ...
    fig.suptitle('Soil Moisture Profile Evolution', fontsize=15, fontweight='bold', y=0.98)
