...
- [x] **GLDAS CLSM 1.0 3H** (`data/validation/intercomparison/GLDAS/GLDAS_CLSM10_3H`) : Modèle d'intercomparaison.
- [x] **GMIA** (`data/land_params/GMIA/`) : Carte des zones irriguées (donnée statique).

### 2. Données Partielles ⚠️
Ces données sont en cours de téléchargement ou ont été interrompues.
- [ ] **GLDAS NOAH 0.25 3H** (`data/validation/intercomparison/GLDAS/GLDAS_NOAH025_3H`) : S'arrête en juin 2018. 
...
- [ ] **GLDAS VIC 1.0 & CLSM-DA1** (`data/validation/intercomparison/GLDAS/`) : Modèles d'intercomparaison.
...
| `vegetation` | FLUXSAT v2 | GPP | `.nc` | 0.05° | 2015-2019 (16 mois)| ⚠️ Partiel | `download_fluxsat_gpp.py` |
| `vegetation` | MODIS LAI/FPAR | LAI, FPAR | `.hdf` | 500m | 2015-2020 | ✅ Complet | `download_modis_mcd15a2h.py` |
| `intercomparison` | GLDAS CLSM 1.0 | SM, Q, ET | `.nc4` | 1.0° | 2015-2020 | ✅ Complet | `download_gldas.py` |
| `intercomparison` | GLDAS NOAH 0.25 | SM, Q, ET | `.nc4` | 0.25° | 2015-2018 | ⚠️ Partiel | `download_gldas.py` |
| `intercomparison` | GLDAS VIC / CLSM-DA| SM, Q, ET, TWSA| N/A | 1.0°/0.25° | N/A | ❌ Manquant | `download_gldas.py` |
