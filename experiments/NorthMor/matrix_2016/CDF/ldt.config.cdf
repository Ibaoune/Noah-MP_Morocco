...
Run domain lower left lat:             20.80
Run domain lower left lon:            -17.30
Run domain upper right lat:            36.00
Run domain upper right lon:           -0.80
...
Name of the preprocessed DA file:    "smap_cdf"

LIS soil moisture output directory:   ./combined_OPL_irr/OUTPUT
...
NASA SMAP soil moisture observation directory:  ../../../../data/observations/SMAP_SPL3SMP_E
NASA SMAP soil moisture data designation: SPL3SMP_E
NASA SMAP search radius for openwater proximity detection:  3
SMAP(NASA) soil moisture Composite Release ID (e.g., R16): "R19"
# ====================================================
