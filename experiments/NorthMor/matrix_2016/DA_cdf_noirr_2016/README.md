...
- **Correction de Biais (CDF Matching) pour SMAP** : **Activée** (Utilise smap_cdf_irr.nc/noirr.nc)
...
3. **Fichiers CDF** : Les fichiers climatologiques SMAP générés par LDT dans le dossier `../CDF/`.
